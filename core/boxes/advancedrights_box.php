 ...
 */
class advancedrightsbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "advancedrights@advancedrights";
    public $boxlabel;
    public $depends = array("advancedrights");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/advancedrights/class/advancedrights.class.php";
